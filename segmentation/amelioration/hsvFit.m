...
load('RGBTrainedHSV.mat','RGBAppleFinal','RGBNonAppleFinal');
...
save('RGBMixtureTrainingHSV.mat', 'mixGaussEstApple', 'mixGaussEstNonApple') ;
end
...
for cGauss =1:k
    mixGaussEst.cov(:,:,cGauss) = randn(1)*eye(nDim,nDim);
end;
